...
public class GetDebtBalanceSample {
    ...
    public static void main(String... args) {
         ...
         ***********************************************************************/
         GetDebtBalanceRequest fpsRequest = new GetDebtBalanceRequest();
        
         // @TODO: set request parameters here

         // invokeGetDebtBalance(service, fpsRequest);
     ...
     */
    public static void invokeGetDebtBalance(AmazonFPS service, GetDebtBalanceRequest fpsRequest) {
        try {
            
            GetDebtBalanceResponse fpsResponse = service.getDebtBalance(fpsRequest);
            ...
            System.out.println();
            if (fpsResponse.isSetGetDebtBalanceResult()) {
                System.out.println("        GetDebtBalanceResult");
                System.out.println();
                GetDebtBalanceResult  getDebtBalanceResult = fpsResponse.getGetDebtBalanceResult();
