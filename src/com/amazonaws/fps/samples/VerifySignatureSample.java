...
public class VerifySignatureSample {
     ...
     */
    public static void invokeVerifySignature(AmazonFPS service, VerifySignatureRequest fpsRequest) {
        try {
            
            VerifySignatureResponse fpsResponse = service.verifySignature(fpsRequest);

            
            System.out.println ("VerifySignature Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    VerifySignatureResponse");
            System.out.println();
            if (fpsResponse.isSetVerifySignatureResult()) {
                System.out.println("        VerifySignatureResult");
                System.out.println();
                VerifySignatureResult  verifySignatureResult = fpsResponse.getVerifySignatureResult();
                if (verifySignatureResult.isSetVerificationStatus()) {
                    System.out.println("            VerificationStatus");
                    System.out.println();
                    System.out.println("                " + verifySignatureResult.getVerificationStatus().value());
                    System.out.println();
                }
            } 
