...
public class RefundSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Refund 
         ***********************************************************************/
         RefundRequest fpsRequest = new RefundRequest();
        
         // @TODO: set request parameters here

         // invokeRefund(service, fpsRequest);
     ...
     */
    public static void invokeRefund(AmazonFPS service, RefundRequest fpsRequest) {
        try {
            
            RefundResponse fpsResponse = service.refund(fpsRequest);

            
            System.out.println ("Refund Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    RefundResponse");
            System.out.println();
            if (fpsResponse.isSetRefundResult()) {
                System.out.println("        RefundResult");
                System.out.println();
                RefundResult  refundResult = fpsResponse.getRefundResult();
                if (refundResult.isSetTransactionId()) {
                    System.out.println("            TransactionId");
                    System.out.println();
                    System.out.println("                " + refundResult.getTransactionId());
                    System.out.println();
                }
                if (refundResult.isSetTransactionStatus()) {
                    System.out.println("            TransactionStatus");
                    System.out.println();
                    System.out.println("                " + refundResult.getTransactionStatus().value());
                    System.out.println();
                }
            } 
