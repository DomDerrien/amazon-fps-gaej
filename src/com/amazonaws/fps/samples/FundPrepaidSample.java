...
/**
 *
 * Fund Prepaid  Samples
 *
 *
 */
public class FundPrepaidSample {

    /**
     * Just add few required parameters, and try the service
     * Fund Prepaid functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * sample for Fund Prepaid 
         ***********************************************************************/
         FundPrepaidRequest fpsRequest = new FundPrepaidRequest();
        
         // @TODO: set request parameters here

         // invokeFundPrepaid(service, fpsRequest);
     ...
     */
    public static void invokeFundPrepaid(AmazonFPS service, FundPrepaidRequest fpsRequest) {
        try {
            
            FundPrepaidResponse fpsResponse = service.fundPrepaid(fpsRequest);

            
            System.out.println ("FundPrepaid Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    FundPrepaidResponse");
            System.out.println();
            if (fpsResponse.isSetFundPrepaidResult()) {
                System.out.println("        FundPrepaidResult");
                System.out.println();
                FundPrepaidResult  fundPrepaidResult = fpsResponse.getFundPrepaidResult();
                if (fundPrepaidResult.isSetTransactionId()) {
                    System.out.println("            TransactionId");
                    System.out.println();
                    System.out.println("                " + fundPrepaidResult.getTransactionId());
                    System.out.println();
                }
                if (fundPrepaidResult.isSetTransactionStatus()) {
                    System.out.println("            TransactionStatus");
                    System.out.println();
                    System.out.println("                " + fundPrepaidResult.getTransactionStatus().value());
                    System.out.println();
                }
            } 
