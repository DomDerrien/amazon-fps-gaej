...
public class GetPrepaidBalanceSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Get Prepaid Balance 
         ***********************************************************************/
         GetPrepaidBalanceRequest fpsRequest = new GetPrepaidBalanceRequest();
        
         // @TODO: set request parameters here

         // invokeGetPrepaidBalance(service, fpsRequest);
     ...
     */
    public static void invokeGetPrepaidBalance(AmazonFPS service, GetPrepaidBalanceRequest fpsRequest) {
        try {
            
            GetPrepaidBalanceResponse fpsResponse = service.getPrepaidBalance(fpsRequest);

            
            System.out.println ("GetPrepaidBalance Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetPrepaidBalanceResponse");
            System.out.println();
            if (fpsResponse.isSetGetPrepaidBalanceResult()) {
                System.out.println("        GetPrepaidBalanceResult");
                System.out.println();
                GetPrepaidBalanceResult  getPrepaidBalanceResult = fpsResponse.getGetPrepaidBalanceResult();
                if (getPrepaidBalanceResult.isSetPrepaidBalance()) {
                    System.out.println("            PrepaidBalance");
                    System.out.println();
                    PrepaidBalance  prepaidBalance = getPrepaidBalanceResult.getPrepaidBalance();
                    if (prepaidBalance.isSetAvailableBalance()) {
                        System.out.println("                AvailableBalance");
                        System.out.println();
                        Amount  availableBalance = prepaidBalance.getAvailableBalance();
                    ...
                    if (prepaidBalance.isSetPendingInBalance()) {
                        ...
                        System.out.println();
                        Amount  pendingInBalance = prepaidBalance.getPendingInBalance();
