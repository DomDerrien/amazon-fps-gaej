 ...
 *
 */
public class VerifySignatureAsyncSample {
    ...
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         VerifySignatureRequest requestOne = new VerifySignatureRequest();
         // @TODO: set request parameters here

         VerifySignatureRequest requestTwo = new VerifySignatureRequest();
         // @TODO: set second request parameters here

         List<VerifySignatureRequest> requests = new ArrayList<VerifySignatureRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokeVerifySignature(service, requests);
    ...
    /**
     * Verify Signature request sample
     * 
     ...
     */
    public static void invokeVerifySignature(AmazonFPSAsync service, List<VerifySignatureRequest> requests) {
        List<Future<VerifySignatureResponse>> responses = new ArrayList<Future<VerifySignatureResponse>>();
        for (VerifySignatureRequest fpsRequest : requests) {
            responses.add(service.verifySignatureAsync(fpsRequest));
        }
        for (Future<VerifySignatureResponse> future : responses) {
            ...
            try {
                VerifySignatureResponse fpsResponse = future.get();
                // Original request corresponding to this response, if needed:
                VerifySignatureRequest originalRequest = requests.get(responses.indexOf(future));
