...
public class GetPaymentInstructionSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Get Payment Instruction 
         ***********************************************************************/
         GetPaymentInstructionRequest fpsRequest = new GetPaymentInstructionRequest();
        
         // @TODO: set request parameters here

         // invokeGetPaymentInstruction(service, fpsRequest);
     ...
     */
    public static void invokeGetPaymentInstruction(AmazonFPS service, GetPaymentInstructionRequest fpsRequest) {
        try {
            
            GetPaymentInstructionResponse fpsResponse = service.getPaymentInstruction(fpsRequest);

            
            System.out.println ("GetPaymentInstruction Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetPaymentInstructionResponse");
            System.out.println();
            if (fpsResponse.isSetGetPaymentInstructionResult()) {
                System.out.println("        GetPaymentInstructionResult");
                System.out.println();
                GetPaymentInstructionResult  getPaymentInstructionResult = fpsResponse.getGetPaymentInstructionResult();
                if (getPaymentInstructionResult.isSetToken()) {
                    System.out.println("            Token");
                    System.out.println();
                    Token  token = getPaymentInstructionResult.getToken();
                ...
                if (getPaymentInstructionResult.isSetPaymentInstruction()) {
                    ...
                    System.out.println();
                    System.out.println("                " + getPaymentInstructionResult.getPaymentInstruction());
                    System.out.println();
                }
                if (getPaymentInstructionResult.isSetCallerReference()) {
                    System.out.println("            CallerReference");
                    System.out.println();
                    System.out.println("                " + getPaymentInstructionResult.getCallerReference());
                    System.out.println();
                }
                if (getPaymentInstructionResult.isSetTokenFriendlyName()) {
                    System.out.println("            TokenFriendlyName");
                    System.out.println();
                    System.out.println("                " + getPaymentInstructionResult.getTokenFriendlyName());
                    System.out.println();
                }
            } 
