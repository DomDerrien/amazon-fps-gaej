 ...
 *
 */
public class GetDebtBalanceAsyncSample {
    ...
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         GetDebtBalanceRequest requestOne = new GetDebtBalanceRequest();
         // @TODO: set request parameters here

         GetDebtBalanceRequest requestTwo = new GetDebtBalanceRequest();
         // @TODO: set second request parameters here

         List<GetDebtBalanceRequest> requests = new ArrayList<GetDebtBalanceRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokeGetDebtBalance(service, requests);
     ...
     */
    public static void invokeGetDebtBalance(AmazonFPSAsync service, List<GetDebtBalanceRequest> requests) {
        List<Future<GetDebtBalanceResponse>> responses = new ArrayList<Future<GetDebtBalanceResponse>>();
        for (GetDebtBalanceRequest fpsRequest : requests) {
            responses.add(service.getDebtBalanceAsync(fpsRequest));
        }
        for (Future<GetDebtBalanceResponse> future : responses) {
            ...
            try {
                GetDebtBalanceResponse fpsResponse = future.get();
                // Original request corresponding to this response, if needed:
                GetDebtBalanceRequest originalRequest = requests.get(responses.indexOf(future));
