...
public class CancelTokenSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Cancel Token 
         ***********************************************************************/
         CancelTokenRequest fpsRequest = new CancelTokenRequest();
        
         // @TODO: set request parameters here

         // invokeCancelToken(service, fpsRequest);
     ...
     */
    public static void invokeCancelToken(AmazonFPS service, CancelTokenRequest fpsRequest) {
        try {
            
            CancelTokenResponse fpsResponse = service.cancelToken(fpsRequest);

            
            System.out.println ("CancelToken Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    CancelTokenResponse");
            System.out.println();
