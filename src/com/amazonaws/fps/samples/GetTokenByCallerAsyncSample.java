 ...
 *
 */
public class GetTokenByCallerAsyncSample {
    ...
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         GetTokenByCallerRequest requestOne = new GetTokenByCallerRequest();
         // @TODO: set request parameters here

         GetTokenByCallerRequest requestTwo = new GetTokenByCallerRequest();
         // @TODO: set second request parameters here

         List<GetTokenByCallerRequest> requests = new ArrayList<GetTokenByCallerRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokeGetTokenByCaller(service, requests);
     ...
     */
    public static void invokeGetTokenByCaller(AmazonFPSAsync service, List<GetTokenByCallerRequest> requests) {
        List<Future<GetTokenByCallerResponse>> responses = new ArrayList<Future<GetTokenByCallerResponse>>();
        for (GetTokenByCallerRequest fpsRequest : requests) {
            responses.add(service.getTokenByCallerAsync(fpsRequest));
        }
        for (Future<GetTokenByCallerResponse> future : responses) {
            ...
            try {
                GetTokenByCallerResponse fpsResponse = future.get();
                // Original request corresponding to this response, if needed:
                GetTokenByCallerRequest originalRequest = requests.get(responses.indexOf(future));
