...
public class SettleDebtSample {
    ...
    public static void main(String... args) {
         ...
         ***********************************************************************/
         SettleDebtRequest fpsRequest = new SettleDebtRequest();
        
         // @TODO: set request parameters here

         // invokeSettleDebt(service, fpsRequest);
     ...
     */
    public static void invokeSettleDebt(AmazonFPS service, SettleDebtRequest fpsRequest) {
        try {
            
            SettleDebtResponse fpsResponse = service.settleDebt(fpsRequest);
            ...
            System.out.println();
            if (fpsResponse.isSetSettleDebtResult()) {
                System.out.println("        SettleDebtResult");
                System.out.println();
                SettleDebtResult  settleDebtResult = fpsResponse.getSettleDebtResult();
