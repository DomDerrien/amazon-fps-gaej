 ...
 *       &lt;sequence>
 *         &lt;element name="AccountBalance" type="{http://fps.amazonaws.com/doc/2008-09-17/}AccountBalance" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAccountBalanceResult {
     ...
     * 
     */
    public GetAccountBalanceResult(final AccountBalance accountBalance) {
     ...
     *     this instance
     */
    public GetAccountBalanceResult withAccountBalance(AccountBalance value) {
    ...
    protected String toXMLFragment() {
        ...
        if (isSetAccountBalance()) {
            ...
            xml.append("<AccountBalance>");
            xml.append(accountBalance.toXMLFragment());
            xml.append("</AccountBalance>");
        } 
        return xml.toString();
    }
    ...
    protected String toJSONFragment() {
        ...
        if (isSetAccountBalance()) {
            ...
            json.append(accountBalance.toJSONFragment());
            json.append("}");
            first = false;
        }
