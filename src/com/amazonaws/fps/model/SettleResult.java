...
@XmlRootElement(name = "SettleResult")
public class SettleResult {
     ...
     * 
     */
    public SettleResult(final String transactionId, final TransactionStatus transactionStatus) {
     ...
     *     this instance
     */
    public SettleResult withTransactionId(String value) {
     ...
     *     this instance
     */
    public SettleResult withTransactionStatus(TransactionStatus value) {
