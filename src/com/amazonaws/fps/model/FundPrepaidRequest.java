 ...
 *         &lt;element name="FundingAmount" type="{http://fps.amazonaws.com/doc/2008-09-17/}Amount" minOccurs="0"/>
...
@XmlRootElement(name = "FundPrepaidRequest")
public class FundPrepaidRequest {
     ...
     * 
     */
    public FundPrepaidRequest(final String senderTokenId, final String prepaidInstrumentId, final Amount fundingAmount, final String callerReference, final String senderDescription, final String callerDescription, final DescriptorPolicy descriptorPolicy, final Integer transactionTimeoutInMins) {
     ...
     *     
     */
    public void setFundingAmount(Amount value) {
        this.fundingAmount = value;
    }

    public boolean isSetFundingAmount() {
        return (this.fundingAmount!= null);
    }
     ...
     *     this instance
     */
    public FundPrepaidRequest withSenderTokenId(String value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withPrepaidInstrumentId(String value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withFundingAmount(Amount value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withCallerReference(String value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withSenderDescription(String value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withCallerDescription(String value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withDescriptorPolicy(DescriptorPolicy value) {
     ...
     *     this instance
     */
    public FundPrepaidRequest withTransactionTimeoutInMins(Integer value) {
    ...
    protected String toJSONFragment() {
        ...
        if (isSetFundingAmount()) {
            if (!first) json.append(", ");
            json.append("\"FundingAmount\" : {");
            Amount  fundingAmount = getFundingAmount();


            json.append(fundingAmount.toJSONFragment());
            json.append("}");
            first = false;
        }
