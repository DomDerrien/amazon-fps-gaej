 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://fps.amazonaws.com/doc/2008-09-17/}RefundResult" minOccurs="0"/>
...
public class RefundResponse {
     ...
     * 
     */
    public RefundResponse(final RefundResult refundResult, final ResponseMetadata responseMetadata) {
     ...
     *     this instance
     */
    public RefundResponse withRefundResult(RefundResult value) {
        setRefundResult(value);
        return this;
    }
     ...
     *     this instance
     */
    public RefundResponse withResponseMetadata(ResponseMetadata value) {
    ...
    public String toXML() {
        ...
        if (isSetRefundResult()) {
            RefundResult  refundResult = getRefundResult();
    ...
    public String toJSON() {
        ...
        if (isSetRefundResult()) {
            ...
            json.append("\"RefundResult\" : {");
            RefundResult  refundResult = getRefundResult();

            json.append(refundResult.toJSONFragment());
            json.append("}");
            first = false;
        } 
        if (isSetResponseMetadata()) {
