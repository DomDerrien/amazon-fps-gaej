 ...
 *       &lt;sequence>
 *         &lt;element name="VerificationStatus" type="{http://fps.amazonaws.com/doc/2008-09-17/}VerificationStatus" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VerifySignatureResult")
public class VerifySignatureResult {
     ...
     * 
     */
    public VerifySignatureResult(final VerificationStatus verificationStatus) {
    ...
    public boolean isSetVerificationStatus() {
     ...
     *     this instance
     */
    public VerifySignatureResult withVerificationStatus(VerificationStatus value) {
    ...
    protected String toXMLFragment() {
        ...
        if (isSetVerificationStatus()) {
            ...
            xml.append(getVerificationStatus().value());
            xml.append("</VerificationStatus>");
        }
        return xml.toString();
    }
    ...
    protected String toJSONFragment() {
        ...
        if (isSetVerificationStatus()) {
            ...
            json.append(quoteJSON("VerificationStatus"));
            json.append(" : ");
            json.append(quoteJSON(getVerificationStatus().value()));
            first = false;
        }
